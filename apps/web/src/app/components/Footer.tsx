      ...
      <div className="container mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="mb-6 md:mb-0">
            <h2 className="text-2xl font-bold mb-4">Ecommercify</h2>
            <p className="text-gray-400 mb-4">
              A modern e-commerce platform with a beautiful user interface and comprehensive shopping experience.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="glass-button p-2 rounded-full text-gray-400 hover:text-white" style={{ color: 'white', backgroundColor: 'rgba(30, 30, 30, 0.5)' }}>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link href="/featured" className="text-gray-300 hover:text-white">Featured</Link></li>
              <li><Link href="/sale" className="text-gray-300 hover:text-white">Sale</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link href="/orders" className="text-gray-300 hover:text-white">Orders</Link></li>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            &copy; {new Date().getFullYear()} Ecommercify. All rights reserved.
          </p>
